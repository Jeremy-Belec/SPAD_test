...
#P contact
(sdegeo:create-rectangle (position (* L_abs -0.25) (+ (- t_Etch t_Ge) t_Si) 0) (position (* L_abs 0.25) (+ t_Ge t_Si) 0) "Germanium" "p_contactt")

#Ge absorber
(sdegeo:create-rectangle (position (+ (* L_abs -0.25) 2) (+ t_Ge t_Si) 0) (position (- (* L_abs 0.25) 2) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact")

#Ge absorber
(sdegeo:create-rectangle (position (* L_abs -0.25) (+ t_Ge t_Si) 0) (position (+ 2 (* L_abs -0.25)) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact_left")

#Ge absorber
(sdegeo:create-rectangle (position (- (* L_abs 0.25) 2) (+ t_Ge t_Si) 0) (position (* L_abs 0.25) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact_right")
#########################################################################################
#Si_charge_layer
...
(sdegeo:set-contact-edges (find-edge-id (position (+ 6 (* L_abs -0.2)) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0)))
#####################################################################################################################
...
(sdedr:define-refeval-window "BaseLine.SourceD" 
  "Line" (position (- (- 0 center) (* 0.5 L_dop)) (- (+ t_Etch t_Si) 1.15) 0.0) (position (+ (- 0 center) (* 0.5 L_dop)) (- (+ t_Etch t_Si) 1.15) 0.0))
...
(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (- (* -0.25 L_abs) 1) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0.0) (position (+ (* -0.25 L_abs) 1) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDRight"
  ...
  "ValueAtDepth" 5e15 "Depth" 3 "Gauss" "Factor" 0.1)
...
(sdedr:define-refeval-window "BaseLine.SourceDRR" 
  "Line" (position (- center (* 0.5 L_dop)) (- (+ t_Etch t_Si) 1.15) 0.0) (position (+ center (* 0.5 L_dop)) (- (+ t_Etch t_Si) 1.15) 0.0))
#Definition of the doping (n,p)
...
#Oxide layer
(sdedr:define-refeval-window "RefEvalWin.Oxideee_layer" "Rectangle"  (position (* L_abs -0.3) t_Si 0) (position (* L_abs 0.3) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) )
