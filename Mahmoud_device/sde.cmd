...
(define t_Ge 0.2) ;Ge absorption layer thickness (p)[um]
...
#P contact
(sdegeo:create-rectangle (position (* L_abs -0.3) t_Si 0) (position (* L_abs 0.3) (+ t_Ge t_Si) 0) "Germanium" "p_contactt")

#Ge absorber
(sdegeo:create-rectangle (position (+ 3 (* L_abs -0.3)) (+ t_Ge t_Si) 0) (position (- (* L_abs 0.3) 3) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact")

#Ge absorber
(sdegeo:create-rectangle (position (* L_abs -0.3) (+ t_Ge t_Si) 0) (position (+ 3 (* L_abs -0.3)) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact_left")

#Ge absorber
(sdegeo:create-rectangle (position (- (* L_abs 0.3) 3) (+ t_Ge t_Si) 0) (position (* L_abs 0.3) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact_right")
#########################################################################################
#Si_charge_layer
...
(sdegeo:set-contact-edges (find-edge-id (position (+ 3 (* L_abs -0.2)) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0)))
#####################################################################################################################
...
#Doping of Si isolation
(sdedr:define-constant-profile "Si_profileP" "BoronActiveConcentration" 2e17)
(sdedr:define-constant-profile-region "Si_regionP" "Si_profileP" "Si_layerP")

(sdedr:define-constant-profile "Si_profileN" "PhosphorusActiveConcentration" 2e17)
...
(sdedr:define-refeval-window "BaseLine.SourceD" 
  "Line" (position (- (- 0 center) 1) t_Si 0.0) (position (+ (- 0 center) 1) t_Si 0.0))
...
(sdedr:define-refeval-window "BaseLine.SourceNC" 
  "Line" (position (- (- 0 center) (* 0.7 L_dop)) t_Si 0.0) (position (+ (- 0 center) (* 0.7 L_dop)) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainNC"
  "PhosphorusActiveConcentration" "PeakPos" 0 "PeakVal" 9e19
...
(sdedr:define-refeval-window "BaseLine.SourceDL" 
  "Line" (position (- (- (- 0 center) 1) 4) t_Si 0.0) (position (- (- 0 center) 1) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDL"
  "PhosphorusActiveConcentration" "PeakPos" 0 "PeakVal" 1e16
  "ValueAtDepth" 5e13 "Depth" 3 "Gauss" "Factor" 0.35)



(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (+ (- 0 center) 1) t_Si 0.0) (position (+ 2 (+ (- 0 center) 1)) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceDRR" 
  "Line" (position (- center 1) t_Si 0.0) (position (+ center 1) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceNCRR" 
  "Line" (position (- center (* 0.7 L_dop)) t_Si 0.0) (position (+ center (* 0.7 L_dop)) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceDLRR" 
  "Line" (position (- (- center 1) 2) t_Si 0.0) (position (- center 1) t_Si 0.0))
#Definition of the doping (n,p)

(sdedr:define-analytical-profile-placement "PlaceAP.SourceDLRR"
  "Gauss.SourceDrainDLRR" "BaseLine.SourceDLRR" "Negative" "NoReplace" "Eval")
...
(sdedr:define-refeval-window "BaseLine.SourceDRightRR" 
  "Line" (position (+ center 1) t_Si 0.0) (position (+ 4 (+ center 1)) t_Si 0.0))
#Definition of the doping (n,p)
