...
(define t_Ge 2) ;Ge absorption layer thickness (p)[um]
...
(define t_abs 0.8) ;thickness absorber wafer (n)[um]
...
#N contact
(sdegeo:create-rectangle (position (* L_abs -0.3) t_Si 0) (position (* L_abs 0.3) (+ t_Si t_abs) 0) "Germanium" "n_contact")

#N contact
(sdegeo:create-rectangle (position (* L_abs -0.3) (+ t_Si t_abs) 0) (position (* L_abs 0.3) (+ t_Ox (+ t_Si t_abs)) 0) "Germanium" "n_contact_contact")
...
#P contact
(sdegeo:create-rectangle (position (+ 2 (* L_Si -0.5)) t_Si 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ge t_Si) 0) "Silicon" "Si_layer_left")

#P contact
(sdegeo:create-rectangle (position (- (* L_Si 0.5) 2) t_Si 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ge t_Si) 0) "Silicon" "Si_layer_right")

#P contact
(sdegeo:create-rectangle (position (+ 2 (* L_Si -0.5)) (+ t_Ge t_Si) 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ox (+ t_Ge t_Si)) 0) "Silicon" "contact_left")

#P contact
(sdegeo:create-rectangle (position (- (* L_Si 0.5) 2) (+ t_Ge t_Si) 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ox (+ t_Ge t_Si)) 0) "Silicon" "contact_right")
...
(sdegeo:set-contact-edges (find-edge-id (position (+ 2 (* L_Si -0.5)) (+ t_Ox (+ t_Ge t_Si)) 0)))
...
(sdegeo:set-contact-edges (find-edge-id (position (- (* L_Si 0.5) 2) (+ t_Ox (+ t_Ge t_Si)) 0)))
...
(sdegeo:set-contact-edges (find-edge-id (position (* L_abs -0.3) (+ t_Ox (+ t_Si t_abs)) 0)))
#####################################################################################################################

#Doping of Si region
(sdedr:define-constant-profile "Si_profile" "BoronActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_region" "Si_profile" "Si_layer")

#Doping of Si region
(sdedr:define-constant-profile "Si_profilee" "BoronActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionn" "Si_profilee" "Si_layer_left")

#Doping of Si region
(sdedr:define-constant-profile "Si_profileee" "BoronActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionnn" "Si_profileee" "Si_layer_right")

#Doping of Si region
(sdedr:define-constant-profile "Si_profileCL" "BoronActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionCL" "Si_profileCL" "contact_left")

#Doping of Si region
(sdedr:define-constant-profile "Si_profileCR" "BoronActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionCR" "Si_profileCR" "contact_right")


#Doping of Ge region
(sdedr:define-constant-profile "Si_profileCC" "PhosphorusActiveConcentration" 1e19)
(sdedr:define-constant-profile-region "Si_regionCC" "Si_profileCC" "n_contact")

#Doping of Ge region
(sdedr:define-constant-profile "Si_profileCCC" "PhosphorusActiveConcentration" 1e19)
(sdedr:define-constant-profile-region "Si_regionCCC" "Si_profileCCC" "n_contact_contact")


#P side

(sdedr:define-refeval-window "BaseLine.SourceD" 
  "Line" (position (* L_abs -0.2) t_Si 0.0) (position (* L_abs 0.2) t_Si 0.0))
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainD"
  ...
  "ValueAtDepth" 1e16 "Depth" 2 "Gauss" "Factor" 0.35)
...
(sdedr:define-refeval-window "BaseLine.SourceDL" 
  "Line" (position (* L_abs 0.35) t_Si 0.0) (position (* L_abs 0.75) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDL"
  "PhosphorusActiveConcentration" "PeakPos" 0 "PeakVal" 5e13
  "ValueAtDepth" 5e13 "Depth" 3 "Gauss" "Factor" 0.35)



(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (* L_abs -0.75) t_Si 0.0) (position (* L_abs -0.35) t_Si 0.0))
#Definition of the doping (n,p)
...
#Oxide layer
(sdedr:define-refeval-window "RefEvalWin.Oxide_layer" "Rectangle"  (position (* L_abs -0.5) t_Si 0) (position (* L_abs 0.5) (+ t_Si t_abs)  0) )
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_left" "Rectangle"  (position (+ 2 (* L_Si -0.5)) t_Si 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ge t_Si) 0))
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_right" "Rectangle"  (position (- (* L_Si 0.5) 2) t_Si 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ge t_Si) 0))
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_left" "Rectangle"  (position (+ 2 (* L_Si -0.5)) (+ t_Ge t_Si) 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ox (+ t_Ge t_Si)) 0))
(sdedr:define-refinement-size "RefinementDefinition.Si_layer_left" 0.5 0.005 0.1 0.001 )
(sdedr:define-refinement-placement "RefinementPlacement.Si_layer_left" "RefinementDefinition.Si_layer_left" (list "window" "RefEvalWin.Si_layer_left"))
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_right" "Rectangle"  (position (- (* L_Si 0.5) 2) (+ t_Ge t_Si) 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ox (+ t_Ge t_Si)) 0))
(sdedr:define-refinement-size "RefinementDefinition.Si_layer_right" 0.5 0.005 0.1 0.001 )
(sdedr:define-refinement-placement "RefinementPlacement.Si_layer_right" "RefinementDefinition.Si_layer_right" (list "window" "RefEvalWin.Si_layer_right"))
