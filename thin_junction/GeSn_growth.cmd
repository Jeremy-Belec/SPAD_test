...
#Doping of Si region
(sdedr:define-constant-profile "Si_profile" "PhosphorusActiveConcentration" 3e16)
(sdedr:define-constant-profile-region "Si_region" "Si_profile" "Si_layer")



#Doping of Si region
(sdedr:define-constant-profile "Si_profileCL" "PhosphorusActiveConcentration" 3e16)
(sdedr:define-constant-profile-region "Si_regionCL" "Si_profileCL" "contact_left")

#Doping of Si region
(sdedr:define-constant-profile "Si_profileCR" "PhosphorusActiveConcentration" 3e16)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainD"
  "PhosphorusActiveConcentration" "PeakPos" 0 "PeakVal" 2.1e18
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainNC"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 2.9e18
  "ValueAtDepth" 5e13 "Depth" 0.30 "Gauss" "Factor" 0.1)
...
(sdedr:define-refeval-window "BaseLine.SourceDL" 
  "Line" (position (* L_abs 0.27) t_Si 0.0) (position (* L_abs 0.55) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDL"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 2e16
  "ValueAtDepth" 2e15 "Depth" 0.8 "Gauss" "Factor" 0.05)



(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (* L_abs -0.55) t_Si 0.0) (position (* L_abs -0.27) t_Si 0.0))
#Definition of the doping (n,p)
