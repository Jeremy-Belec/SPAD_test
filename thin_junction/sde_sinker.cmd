...
#N contact
(sdegeo:create-rectangle (position (* L_abs -0.3) t_Si 0) (position (* L_abs 0.3) (+ t_Si t_Ox) 0) "Gold" "n_contact")
...
#P contact
(sdegeo:create-rectangle (position (+ 2 (* L_Si -0.5)) t_Si 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ox t_Si) 0) "Gold" "P_cont_layer_left")

#P contact
(sdegeo:create-rectangle (position (- (* L_Si 0.5) 2) t_Si 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ox t_Si) 0) "Gold" "P_cont_layer_right")
...
(sdegeo:set-contact-edges (find-edge-id (position (+ 2 (* L_Si -0.5)) (+ t_Si t_Ox) 0)))
...
(sdegeo:set-contact-edges (find-edge-id (position (- (* L_Si 0.5) 2) (+ t_Si t_Ox) 0)))
...
(sdegeo:set-contact-edges (find-edge-id (position (* L_abs -0.3) (+ t_Si t_Ox) 0)))
#####################################################################################################################
...
(sdedr:define-refeval-window "BaseLine.SourceNC" 
  "Line" (position (* L_abs -0.3) t_Si 0.0) (position (* L_abs 0.3) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceN" 
  "Line" (position (- (- (* L_Si 0.5) L_dop) 2) t_Si 0.0) (position (- (* L_Si 0.5)  2) t_Si 0.0))
#Definition of the doping (n,p)

(sdedr:define-analytical-profile-placement "PlaceAP.Source1"
  "Gauss.SourceDrainN" "BaseLine.SourceN" "Negative" "NoReplace" "Eval")

(sdedr:define-gaussian-profile "Gauss.SourceDrainN"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 1e18
  "ValueAtDepth" 5e15 "Depth" 2 "Gauss" "Factor" 0.35)


#P side

(sdedr:define-refeval-window "BaseLine.SourceP" 
  "Line" (position (+ 2 (* L_Si -0.5)) t_Si 0.0) (position (+ 2 (+ L_dop (* L_Si -0.5))) t_Si 0.0))
#Definition of the doping (n,p)

(sdedr:define-analytical-profile-placement "PlaceAP.Source2"
  "Gauss.SourceDrainP" "BaseLine.SourceP" "Negative" "NoReplace" "Eval")
...
#Oxide layer
(sdedr:define-refeval-window "RefEvalWin.Oxide_layer" "Rectangle"  (position (* L_abs -0.5) t_Si 0) (position (* L_abs 0.5) (+ t_Si t_Ox)  0) )
...
(sdedr:define-refeval-window "RefEvalWin.P_contact_layer" "Rectangle"  (position (+ 2 (* L_Si -0.5)) t_Si 0) (position (+ 2 (+ L_dop (* L_Si -0.5))) (+ t_Ox t_Si) 0))
...
(sdedr:define-refeval-window "RefEvalWin.N_contact_layer" "Rectangle"  (position (- (* L_Si 0.5) 2) t_Si 0) (position (- (- (* L_Si 0.5) L_dop) 2) (+ t_Ox t_Si) 0))
