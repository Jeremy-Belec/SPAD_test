...
(define t_Si 0.7) ;Si charge sheet thickness (p)[um]
...
(sdedr:define-refinement-size "RefinementDefinition.Ge_layer" 0.05 0.05 0.01 0.005 )
...
(sdedr:define-refinement-size "RefinementDefinition.Oxide_layer" 0.05 0.0015 0.01 0.0002 )
...
(sdedr:define-refinement-size "RefinementDefinition.Si_multiplication_layer" 0.05 0.05 0.01 0.005 )
...
(sdedr:define-refinement-size "RefinementDefinition.P_contact_layer" 0.1 0.005 0.05 0.001 )
...
(sdedr:define-refinement-size "RefinementDefinition.N_contact_layer" 0.1 0.005 0.05 0.001 )
