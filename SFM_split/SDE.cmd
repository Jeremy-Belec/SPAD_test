...
(sdedr:define-constant-profile "Si_profileP" "BoronActiveConcentration" 1e16)
(sdedr:define-constant-profile-region "Si_regionP" "Si_profileP" "Si_layerP")

(sdedr:define-constant-profile "Si_profileN" "PhosphorusActiveConcentration" 1e19)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainD"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 5e17
...
(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (+ (- 0 center) 1) t_Si 0.0) (position (+ 1.5 (+ (- 0 center) 1)) t_Si 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceDLRR" 
  "Line" (position (- (- center 1) 1.5) t_Si 0.0) (position (- center 1) t_Si 0.0))
#Definition of the doping (n,p)
