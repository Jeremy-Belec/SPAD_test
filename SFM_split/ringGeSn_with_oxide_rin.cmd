...
(define t_Etch 0.5) ;Etch depth (p)[um]
...
#Si etch
(sdegeo:create-rectangle (position (* L_abs -0.25) t_Si 0) (position (* L_abs 0.25) (+ (- t_Etch t_Ge) t_Si) 0) "Silicon" "Si_Etch")
...
#SiO2
(sdegeo:create-rectangle (position (- (* L_abs -0.25) 2) t_Si 0) (position (* L_abs -0.25) (+ t_Etch t_Si) 0) "SiO2" "Si_Etch")

(sdegeo:create-rectangle (position (* L_abs 0.25) t_Si 0) (position (+ (* L_abs 0.25) 2) (+ t_Etch t_Si) 0) "SiO2" "Si_Etch")
...
#Ge absorber
(sdegeo:create-rectangle (position (+ 2 (* L_abs -0.25)) (+ t_Etch t_Si) 0) (position (- (* L_abs 0.25) 2) (+ t_Etch (+ t_Si (* 10 t_Ox))) 0) "Germanium" "p_contact")
...
(sdedr:define-constant-profile "Si_profileE" "BoronActiveConcentration" 1e15)
(sdedr:define-constant-profile-region "Si_regionE" "Si_profileE" "Si_Etch")
