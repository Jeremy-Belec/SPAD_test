...
(define t_Etch 0.45) ;Etch depth (p)[um]
...
#SiO2
(sdegeo:create-rectangle (position (- (* L_abs -0.25) 1.5) t_Si 0) (position (* L_abs -0.25) (+ t_Etch t_Si) 0) "SiO2" "SiO2_Etch")

(sdegeo:create-rectangle (position (* L_abs 0.25) t_Si 0) (position (+ (* L_abs 0.25) 1.5) (+ t_Etch t_Si) 0) "SiO2" "SiO2_Etch")
...
(sdedr:define-constant-profile "Si_profileEC" "BoronActiveConcentration" 5e15)
(sdedr:define-constant-profile-region "Si_regionEC" "Si_profileEC" "Si_EtchC")

(sdedr:define-constant-profile "Si_profileEL" "BoronActiveConcentration" 5e15)
(sdedr:define-constant-profile-region "Si_regionEL" "Si_profileEL" "Si_Etch_Left")

(sdedr:define-constant-profile "Si_profileER" "BoronActiveConcentration" 5e15)
...
(sdedr:define-refeval-window "BaseLine.SourceD" 
  "Line" (position (- (- 0 center) 1.3) (+ t_Etch t_Si) 0.0) (position (+ (- 0 center) 1.3) (+ t_Etch t_Si) 0.0))
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainD"
  ...
  "ValueAtDepth" 5e17 "Depth" 1.0 "Gauss" "Factor" 0.2)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDL"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 4e15
  "ValueAtDepth" 1e15 "Depth" 2 "Gauss" "Factor" 0.35)



(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (+ (- 0 center) 1) (+ t_Etch t_Si) 0.0) (position (+ 3.5 (+ (- 0 center) 1)) (+ t_Etch t_Si) 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainDRight"
  "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 7e15
  "ValueAtDepth" 1e15 "Depth" 0.6 "Gauss" "Factor" 0.1)
...
(sdedr:define-refeval-window "BaseLine.SourceDRR" 
  "Line" (position (- center 1.3) (+ t_Etch t_Si) 0.0) (position (+ center 1.3) (+ t_Etch t_Si) 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceDLRR" 
  "Line" (position (- (- center 1) 3.5) (+ t_Etch t_Si) 0.0) (position (- center 1) (+ t_Etch t_Si) 0.0))
#Definition of the doping (n,p)
...
###########################
#SiO2
(sdedr:define-refeval-window "RefEvalWin.Si_multiplication_layer_SiO2L" "Rectangle"  (position (- (* L_abs -0.25) 1.5) t_Si 0) (position (* L_abs -0.25) (+ t_Etch t_Si) 0))
...
(sdedr:define-refeval-window "RefEvalWin.Si_multiplication_layer_SiO2R" "Rectangle"  (position (* L_abs 0.25) t_Si 0) (position (+ (* L_abs 0.25) 1.5) (+ t_Etch t_Si) 0))
