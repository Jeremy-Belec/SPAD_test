...
#Ge_contact_layer
(sdegeo:create-rectangle (position  0 (* L_contact -0.5) 0) (position A (* L_contact 0.5) 0) "Germanium" "Ge_contact_layer")



#Ge_absorption_layer
(sdegeo:create-rectangle (position A (* L_mult -0.5) 0) (position (+ A B) (* L_mult 0.5) 0) "Germanium" "Ge_absorption_layer")
...
#Si_contact_layer
(sdegeo:create-rectangle (position (+ D (+ C (+ A B))) (* L_dev -0.5) 0) (position (+ E(+ D (+ C (+ A B)))) (* L_dev 0.5) 0) "Silicon" "Si_contact_layer")
...
(sdegeo:set-contact-edges (find-edge-id (position (+ E(+ D (+ C (+ A B)))) 0 0)))
