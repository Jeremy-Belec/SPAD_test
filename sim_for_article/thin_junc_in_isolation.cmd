...
(define t_Ge 0.9) ;Ge absorption layer thickness (p)[um]
...
#N contact
(sdegeo:create-rectangle (position (* L_abs -0.4) t_Si 0) (position (* L_abs 0.4) (+ t_Ge t_Si) 0) "Germanium" "n_contactt")

#N contact
(sdegeo:create-rectangle (position (* L_abs -0.35) (+ t_Ge t_Si) 0) (position (* L_abs 0.35) (+ t_Ge (+ t_Si (* 10 t_Ox))) 0) "Germanium" "n_contact")
...
#Si extension
(sdegeo:create-rectangle (position (* L_Si -0.5) t_Si 0) (position (* L_abs -0.4) (+ t_Ge t_Si) 0) "Silicon" "Si_layer_left")

(sdegeo:create-rectangle (position (* L_abs 0.4) t_Si 0) (position (* L_Si 0.5) (+ t_Ge t_Si) 0) "Silicon" "Si_layer_right")
...
####################################################################
#P contact
(sdegeo:create-rectangle (position (+ 5 (* L_Si -0.5)) (+ t_Ge t_Si) 0) (position (+ 5 (+ L_dop (* L_Si -0.5))) (+ t_Ox (+ t_Ge t_Si)) 0) "Silicon" "contact_left")

#P contact
(sdegeo:create-rectangle (position (- (* L_Si 0.5) 5) (+ t_Ge t_Si) 0) (position (- (- (* L_Si 0.5) L_dop) 5) (+ t_Ox (+ t_Ge t_Si)) 0) "Silicon" "contact_right")
...
(sdegeo:set-contact-edges (find-edge-id (position (+ 5 (* L_Si -0.45)) (+ t_Ox (+ t_Ge t_Si)) 0)))
...
(sdegeo:set-contact-edges (find-edge-id (position (- (* L_Si 0.45) 5) (+ t_Ox (+ t_Ge t_Si)) 0)))
...
#Doping of Si extension
(sdedr:define-constant-profile "Si_profileCL_ext" "PhosphorusActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionCL_ext" "Si_profileCL_ext" "Si_layer_left")

(sdedr:define-constant-profile "Si_profileCR_ext" "PhosphorusActiveConcentration" 5e13)
(sdedr:define-constant-profile-region "Si_regionCR_ext" "Si_profileCR_ext" "Si_layer_right")
...
(sdedr:define-refeval-window "BaseLine.SourceD" 
  "Line" (position (* L_abs -0.35) t_Si 0.0) (position (* L_abs 0.35) t_Si 0.0))
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainD"
  ...
  "ValueAtDepth" 5e13 "Depth" 2 "Gauss" "Factor" 0.1)
...
(sdedr:define-gaussian-profile "Gauss.SourceDrainNC"
  ...
  "ValueAtDepth" 5e13 "Depth" 0.40 "Gauss" "Factor" 0.1)
...
(sdedr:define-refeval-window "BaseLine.SourceDL" 
  "Line" (position (* L_abs 0.40) (+ t_Ge t_Si) 0.0) (position (* L_abs 0.75) (+ t_Ge t_Si) 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.SourceDRight" 
  "Line" (position (* L_abs -0.75) (+ t_Ge t_Si) 0.0) (position (* L_abs -0.40) (+ t_Ge t_Si) 0.0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.Source_Sinker_left" 
  "Line" (position (+ 5 (* L_Si -0.5)) (+ t_Ge t_Si) 0) (position (+ 5 (+ L_dop (* L_Si -0.5))) (+ t_Ge t_Si) 0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "BaseLine.Source_Sinker_rightt" 
  "Line" (position (- (- (* L_Si 0.5) L_dop) 5) (+ t_Ge t_Si) 0) (position (- (* L_Si 0.5) 5) (+ t_Ge t_Si) 0))
#Definition of the doping (n,p)
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_left" "Rectangle"  (position (+ 5 (* L_Si -0.5)) (+ t_Ge t_Si) 0) (position (+ 5 (+ L_dop (* L_Si -0.5))) (+ t_Ox (+ t_Ge t_Si)) 0))
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_right" "Rectangle"  (position (- (* L_Si 0.5) 5) (+ t_Ge t_Si) 0) (position (- (- (* L_Si 0.5) L_dop) 5) (+ t_Ox (+ t_Ge t_Si)) 0))
...
(sdedr:define-refeval-window "RefEvalWin.Si_layer_left_ext" "Rectangle"  (position (* L_Si -0.5) t_Si 0) (position (* L_abs -0.3) (+ t_Ge t_Si) 0))
(sdedr:define-refinement-size "RefinementDefinition.Si_layer_left_ext" 0.5 0.005 0.1 0.001 )
(sdedr:define-refinement-placement "RefinementPlacement.Si_layer_left_ext" "RefinementDefinition.Si_layer_left_ext" (list "window" "RefEvalWin.Si_layer_left_ext"))


#P contact

(sdedr:define-refeval-window "RefEvalWin.Si_layer_right_ext" "Rectangle"  (position (* L_abs 0.3) t_Si 0) (position (* L_Si 0.5) (+ t_Ge t_Si) 0))
(sdedr:define-refinement-size "RefinementDefinition.Si_layer_right_ext" 0.5 0.005 0.1 0.001 )
(sdedr:define-refinement-placement "RefinementPlacement.Si_layer_right_ext" "RefinementDefinition.Si_layer_right_ext" (list "window" "RefEvalWin.Si_layer_right_ext"))
